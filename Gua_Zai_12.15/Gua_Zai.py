...
def testIntent():
    ...
    inputLIST = ['在內','在於','在2009','在90%中','在桌上','在800年前','在前後文','在該範圍內','在軟體方面','長度在0以上','在西元前800年','收錄在第三頁','在福智高級中學','在不確定的世界裡','在古典與現代之間悠遊','在短期內較易收得成效']
    ...
    # Zai_Loc
    print("[TEST] Zai_Loc")
    inputLIST = ['保持在','在台灣','在浴室','在別台電腦','在同一電腦','在福建省中','在科學機構','在我國之申請案','在有限的預算中','在東方320公里外','在正式課程之外','在「尚有庫存」內出貨']
