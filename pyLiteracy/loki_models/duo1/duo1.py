...
def testIntent():
    # dou_adv
    print("[TEST] dou_adv")
    inputLIST = ['都多了兩歲','都多了兩公分','都用了一千多年','都看了兩部電影','都花了一千多塊']
    testLoki(inputLIST, ['dou_adv'])
    print("")

    # dou
    print("[TEST] dou")
    inputLIST = ['都幾','兩個都','我們都','每次都','都沒有','都給你','我們不都','兩個房子都']
    testLoki(inputLIST, ['dou'])
    print("")
